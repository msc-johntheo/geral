...
def evaluate(individual):
    ...
    r1 = max(0, ind[0] + ind[3] + ind[6] + ind[9] - 10)/65526
    r2 = max(0, ind[1] + ind[4] + ind[7] + ind[10] - 16)/65520
    r3 = max(0, ind[2] + ind[5] + ind[8] + ind[11] - 8)/65528

    # Restricoes de volume
    r4 = max(0.0, ind[0] * 0.48 + ind[3] * 0.65 + ind[6] * 0.58 + ind[9] * 0.39 - 6.8)/34338.4
    r5 = max(0.0, ind[1] * 0.48 + ind[4] * 0.65 + ind[7] * 0.58 + ind[10] * 0.39 - 8.7)/34397.7
    r6 = max(0.0, ind[2] * 0.48 + ind[5] * 0.65 + ind[8] * 0.58 + ind[11] * 0.39 - 5.3)/34333.1

    # Restricoes de carga maxima
    r7 = max(0, ind[0] + ind[1] + ind[2] - 18)/49134
    r8 = max(0, ind[3] + ind[4] + ind[5] - 15)/49131
    r9 = max(0, ind[6] + ind[7] + ind[8] - 23)/49129
    r10 = max(0, ind[9] + ind[10] + ind[11] - 12)/49140

    # Restricoes de equilibrio
    r11 = abs((ind[0] + ind[3] + ind[6] + ind[9]) / 10 - (ind[1] + ind[4] + ind[7] + ind[10]) / 16)/6553.6
    r12 = abs((ind[0] + ind[3] + ind[6] + ind[9]) / 10 - (ind[2] + ind[5] + ind[8] + ind[11]) / 8)/8192
    r13 = abs((ind[2] + ind[5] + ind[8] + ind[11]) / 8 - (ind[1] + ind[4] + ind[7] + ind[10]) / 16)/8192

    g = (sum_c1 * l1 + sum_c2 * l2 + sum_c3 * l3 + sum_c4 * l4)/21708800
    h = (r1 + r2 + r3 + r4 + r5 + r6 + r7 + r8 + r9 + r10 + r11 + r12 + r13)/13
